...
export const deleteAchievement = (Achievement) => {
  return Api.delete(`/achievement`, { data: Achievement })
    .then((response) => {
      // Xử lý dữ liệu trả về từ response ở đây
      return response.data;
    })
...
export const getAchievementByUserID = (userID) => {
...
export const searchAchievement = (params) => {
  return Api.get("/achievement", { params })
    .then((response) => {
      // Xử lý dữ liệu trả về từ response ở đây
      return response.data;
    })
